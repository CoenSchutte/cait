...
<head>
    ...
    <link rel="apple-touch-icon" href="images/logo-stir-zwart.png">
                ...
                <ul class="navbar-nav navbar-nav-scroll ms-auto">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="homeMenu">
                            ...
                            <li><a class="dropdown-item" href="index-11.html">Home Shop <span
                                        class="badge bg-danger smaller me-1">New</span></a></li>
                        </ul>
                    </li>
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="pagesMenu">
                            ...
                            <li class="dropdown-submenu dropend">
                                <a class="dropdown-item dropdown-toggle" href="#">Shop <span
                                        class="badge bg-danger smaller me-1">New</span></a>
                                <ul class="dropdown-menu dropdown-menu-start" data-bs-popper="none">
                                    <li><a class="dropdown-item" href="shop-grid.html">Shop grid <span
                                                class="badge bg-danger smaller me-1">New</span></a></li>
                                    <li><a class="dropdown-item" href="shop-detail.html">Shop detail <span
                                                class="badge bg-danger smaller me-1">New</span></a></li>
                                    <li><a class="dropdown-item" href="checkout.html">Checkout <span
                                                class="badge bg-danger smaller me-1">New</span></a></li>
                                    <li><a class="dropdown-item" href="my-cart.html">Cart <span
                                                class="badge bg-danger smaller me-1">New</span></a></li>
                                    <li><a class="dropdown-item" href="empty-cart.html">Empty cart <span
                                                class="badge bg-danger smaller me-1">New</span></a></li>
                                </ul>
                            </li>
                            <!-- Dropdown submenu -->
                        ...
                        <ul class="dropdown-menu" aria-labelledby="postMenu">
                            ...
                            <li class="dropdown-submenu dropend">
                                ...
                                <ul class="dropdown-menu dropdown-menu-start" data-bs-popper="none">
                                    ...
                                    <li><a class="dropdown-item" href="post-grid-masonry-filter.html">Post grid masonry
                                            filter</a></li>
                                    <li><a class="dropdown-item" href="post-large-and-grid.html">Post mixed large than
                                            grid</a></li>
                                </ul>
                            </li>
                                        ...
                                        <div class="card bg-transparent">
                                            ...
                                            <div class="card-body px-0 pt-3">
                                                <h6 class="card-title mb-0"><a href="#"
                                                        ...
                                                        worst types of business accounts you follow on Twitter</a></h6>
                                                <!-- Card info -->
                                                <ul class="nav nav-divider align-items-center text-uppercase small mt-2">
                                                    <li class="nav-item">
    ...
    <div class="container">
        ...
        <div class="row pt-5">
            ...
            <div class="col-md-6 col-lg-4 mb-4">
                <img class="light-mode-item" src="images/logo.svg" alt="logo">
                <img class="dark-mode-item" src="images/logo-light.svg" alt="logo">
                ...
                <div class="mt-4">©2022 <a href="https://www.webestica.com/" class="text-reset btn-link"
