...
@section('content')
    <section class="pt-4">
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <div class="card bg-dark-overlay-4 overflow-hidden card-bg-scale h-400 text-center" style="background-image:url(../images/blog/16by9/09.jpg); background-position: center left; background-size: cover;">
                        <!-- Card Image overlay -->
...
{{--                                <!-- Avatar img -->--}}
{{--                                <div class="avatar avatar-xxl mb-2">--}}
{{--                                    <img class="avatar-img rounded-circle" src="../images/avatar/14.jpg" alt="avatar">--}}
{{--                                </div>--}}
...
{{--                            <img class="rounded" src="../images/blog/3by2/04.jpg" alt="Card image">--}}
...
{{--                        <!-- Service item-->--}}
{{--                        <div class="col-md-6 col-lg-4 mb-4">--}}
{{--                            <img class="rounded" src="../images/blog/3by2/01.jpg" alt="Card image">--}}
...
{{--                        <!-- Service item-->--}}
{{--                        <div class="col-md-6 col-lg-4 mb-4">--}}
{{--                            <img class="rounded" src="../images/blog/3by2/03.jpg" alt="Card image">--}}
