<x-guest-layout>
    <x-jet-authentication-card>
        <x-slot name="logo">
            <a href="/">
                <img src="{{asset('images/logo-stir-zwart.png')}}" alt="Stir Logo" class="w-full h-16">
            </a>
        </x-slot>
        ...
        <form method="POST" action="{{ route('register') }}">
            ...
            <div class="mt-4">
                ...
                <x-jet-input id="student_number" class="block mt-1 w-full" type="text" name="student_number" :value="old('student_number')" required />
            </div>
